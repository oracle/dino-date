...
ALTER USER dd DEFAULT TABLESPACE ZVC1ZKXNEP_DATA QUOTA UNLIMITED ON ZVC1ZKXNEP_DATA;
...
ALTER USER dd_non_ebr DEFAULT TABLESPACE ZVC1ZKXNEP_DATA QUOTA UNLIMITED ON ZVC1ZKXNEP_DATA;
